...
class Rule:
    ...
    def __init__(self, id, name, description, level, condition=None, checks=None):
        """Initialize the rule."""
        self.id = id
        self.name = name
...
class RuleResult:
    ...
    def to_dict(self):
        ...
        return {
            ...
            "checks": [r.to_dict() for r in self.check_results if not r.success],
        }
...
class RuleParser:
    ...
    def parse(cls, config):
        ...
        return Rule(rule_id, name, description, level, condition, checks)
